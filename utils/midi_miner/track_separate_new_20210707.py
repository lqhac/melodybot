...
def remove_drum_empty_track(midi_file):
    ...
    1. read pretty midi_2 data, remove the drum track
...
def walk(folder_name):
    ...
    for p, d, f in os.walk(folder_name):
        for file in f:
            ...
            if endname == 'mid' or endname == 'midi_2':
...
def all_features(midi_file):
    '''
    compute 34 features from midi_2 data. Each track of each song have 30 features
    ...
    across different tracks within a midi_2 file
